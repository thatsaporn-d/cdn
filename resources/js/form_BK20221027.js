                                 ...
                                 if (formMode == 'inbox' && btn.slot1) {
                                    ...
                                    if (key) {
                                       ...
                                       parent.add(new Senate.MainForm({
                                          ...
                                          mainBody: body,
                                          formMode: 'editFrm',
                                          tempInbox: Ext.getCmp('inbox-tab').temp
                                       }));
                                       parent.doLayout();
                                    } else {
                  ...
                  var jsonBtn = {
                     ...
                     handler: function(btn) {
                        ...
                        if (valid) {
                           ...
                           var win = new Senate.FormWindow();
                           win.showMulti(panel, btn.gfmID, btn.refGrid, btn.btnIndex, scriptText, btn.refGrid.fmWidth, btn.refGrid.fmHeight);
                        }
                     }
                  };
