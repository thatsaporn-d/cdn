...
Ext.onReady(function(){	
	...
	Ext.Ajax.request({
		...
		success: function(result) {
			...
			new Senate.MainView();
			var mainFrm = Ext.getCmp('main-form');
			if(mainFrm == undefined) 
				if(Senate.user != null && Senate.firstLogin == 0) openCalendar();
		}
	});
...
function loadCalendar(){
	...
	calendar = Ext.getCmp('body-panel').items.get(0).items.get(0);
